...
(async () => {
  ...
  await fs.writeFile("systemic-sclerosis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("systemic-sclerosis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
